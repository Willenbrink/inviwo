...
public:
    ...
    static dvec2 RK4(const VectorField2& vectorField, const dvec2& position, const double stepSize, const bool forwards = true);
    static dvec2 RK4_norm(const VectorField2& vectorField, const dvec2& position, const double stepSize, const bool forwards = true);
